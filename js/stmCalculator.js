...
function calculate() {
    ...
    let remainingPayPeriods = +document.getElementById("remaining-pay-periods").value;
    ...
    result1.innerHTML =
        "<p>Maximum Contribution per Remaining Pay Period (in INR): " + maxContribPerPayPeriod.toFixed(2) + "</p>";
    result2.innerHTML =
        "<p>Amount Remaining to Max Contribution (in INR): " + amountRemaining.toFixed(2) + "</p>";
}
