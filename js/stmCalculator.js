let maxContribLimit = Number(document.getElementById("contribution-limit").value);
    let contribToDate = Number(document.getElementById("contribution-to-date").value);
    let remainingPayPeriods = Number(document.getElementById("remaining-pay-periods").value);
...
function calculate() {
    ...
    let maxContribPerPayPeriod = (maxContribLimitTotal - contribToDate) / remainingPayPeriods;
    ...
    document.getElementById("max-contribution").value = maxContribPerPayPeriod.toFixed(2);
    document.getElementById("amount-remaining").value = amountRemaining.toFixed(2);
  }
  function resetForm() {
